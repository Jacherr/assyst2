...
use twilight_model::{gateway::payload::incoming::MessageUpdate, channel::{Message, message::MessageType}, util::Timestamp};
...
/// 2. A message was edited into a different command, in which case execute the new command and edit the response message,
